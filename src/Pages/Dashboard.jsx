    ...
    const fetchActivity = async () => {
        ...
        if (ProposalIds) {
            ...
            ProposalIds.forEach((item) => {
                ...
                proposalData.minifiedAddress = storage.proposalDetails[item].proposer.slice(0, 4) + "..." + address.slice(-4);
                ...
                proposalData.votesInFavour = storage.proposalDetails[item].votesInFavour;
                ...
                ? isAMember
                            ...
                            >
                                ...
                                <div className="w-full h-full max-h-[430px] flex-1 flex flex-col lg:flex-row justify-center p-0 gap-[50px]">
                                    ...
                                    <div className="flex flex-col items-center p-0 gap-[20px] w-1/2 flex-2">
                                        ...
                                        <div
                                            className={`flex flex-col items-center p-0 gap-[10px] w-full h-full max-h-[365px] overflow-x-hidden overflow-y-auto pr-2 ${activityLoading
                                                ? "justify-center"
                                            ...
                                            {members.map((item, index) => {
                                                return (
                                                    ...
                                                    >
                                                        {
                                                            item === address
                                                                ? "You (" + item.slice(0, 4) + " ... " + item.slice(-4) + ")"
                    ...
                    : <div className="border-box w-screen min-h-[calc(100vh-250px)] max-h-[calc(100vh-250px)] gap-5 lg:gap-10 flex flex-col justify-center items-center">
                        ...
                        <p className="text-primaryBlack/70 text-2xl font-medium lg:w-1/2 text-center">
                            Looks like you are not a member of any SHG. Either create an SHG or Join an existing SHG
                        </p>
