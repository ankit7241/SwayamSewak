...
export default function DepositFundsModal({ shgId, setOpenDepositModal, setOpenRequestModal }) {
            ...
            >

                {
                    loading
                        ...
                        : <>
                            <h3 className="font-medium text-2xl text-white font-mammoth">Deposit Funds</h3>
