...
export default function RequestFundsModal({ shgId, setOpenDepositModal, setOpenRequestModal }) {
    ...
    const OpenRequestFunds = async () => {
        ...
        try {
            ...
            toast.success(`Proposal created successfully! Waiting for other members to vote`, {
                position: "top-center",
                autoClose: 5000,
            ...
            >

                {
                    loading
                        ...
                        : <>
                            <h3 className="font-medium text-2xl text-white font-mammoth">Request for Funds</h3>
