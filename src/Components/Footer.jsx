...
const Footer = () => {
    return (
        <div className='flex flex-row justify-between items-center py-10 px-30 mx-[20px] mb-[20px] mt-[70px] border-primaryWidth border-white/10 rounded-10 bg-primaryBlack'>
            ...
            <h4 className='font-medium text-xs text-white/75 cursor-default'>Crafted with ❤️ & ☕ | Team Code Chain</h4>
