...
const Button = (props) => {
    return (
        <button className="z-20 cursor-pointer flex items-center justify-center py-10 px-15 bg-white/5 border-primaryWidth border-white/10 rounded-20 shadow-xl hover:bg-white/10 hover:scale-105 transition">
            {
                props.gradient
