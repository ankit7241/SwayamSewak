...
export default function JoinShgModal({ shgId, setOpenJoinSHG, shgDetails }) {
    ...
    const DepositJoinShg = async () => {
        try {
            ...
            toast.success(`woohoo! Funds deposited successfully. You are now a member of an SHG`, {
                position: "top-center",
                autoClose: 5000,
            ...
            >

                {
                    loading
                        ...
                        : isAMember
                            ? <>
                                <h3 className="font-medium text-2xl text-white cursor-default">You are already a member of an SHG</h3>
                                <Button
                                    varient="light"
                                    gradient={false}
                                    weight={"semibold"}
                            ...
                            : <><div className="flex flex-col items-center p-0 gap-[5px]">
                                <h3 className="font-medium text-2xl text-white font-mammoth">{shgName}</h3>
